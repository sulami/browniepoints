...
return [(function (){var pred__50895 = cljs.core.instance_QMARK_;
var expr__50896 = reactive_val;
if(cljs.core.truth_((pred__50895.cljs$core$IFn$_invoke$arity$2 ? pred__50895.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__50896) : pred__50895.call(null,reagent.ratom.RAtom,expr__50896)))){
return "ra";
} else {
if(cljs.core.truth_((pred__50895.cljs$core$IFn$_invoke$arity$2 ? pred__50895.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__50896) : pred__50895.call(null,reagent.ratom.RCursor,expr__50896)))){
return "rc";
} else {
if(cljs.core.truth_((pred__50895.cljs$core$IFn$_invoke$arity$2 ? pred__50895.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__50896) : pred__50895.call(null,reagent.ratom.Reaction,expr__50896)))){
return "rx";
} else {
if(cljs.core.truth_((pred__50895.cljs$core$IFn$_invoke$arity$2 ? pred__50895.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__50896) : pred__50895.call(null,reagent.ratom.Track,expr__50896)))){
return "tr";
} else {
return "other";
}
