...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47095 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_47095(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_47107 = (function (runtime,key,spec){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_47107(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_47111 = (function (runtime,key){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_47111(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_47118 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_47118(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47128 = (function (runtime,input,callback){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_47128(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47134 = (function (runtime,code){
var x__4428__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_47134(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__47088,callback){
var map__47089 = p__47088;
...
var input = map__47089__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47089__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47089__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
