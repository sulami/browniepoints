...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43908 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43908(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43914 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43914(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43929 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43929(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43937 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43937(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43956 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43956(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43963 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43963(reader);
}
});
...
var G__44054 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__44055 = s.append(c);
c = G__44054;
s = G__44055;
continue;
}
