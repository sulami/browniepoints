...
var G__42323 = (i__4737__auto___42321 + (1));
i__4737__auto___42321 = G__42323;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq42272){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__42289_SHARP_){
return (!((cljs.core.meta(p1__42289_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42300__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e42304){var _e__41243__auto__ = e42304;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e42306){var _e__41243__auto__ = e42306;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__42309 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__42310 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__42310);

try{var map__42312 = opts;
var map__42312__$1 = (((((!((map__42312 == null))))?(((((map__42312.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__42312.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__42312):map__42312);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42312__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__42309);
}});
...
var temp__5733__auto___42335 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___42335)){
var managed_print_level_42336 = temp__5733__auto___42335;
var _STAR_print_level_STAR__orig_val__42317_42337 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__42318_42338 = managed_print_level_42336;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__42318_42338);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__42314_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__42314_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__42317_42337);
}} else {
job_fn();
}
