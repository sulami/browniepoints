...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_44414 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_44414(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_44424 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_44424(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_44426 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_44426(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_44435 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_44435(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_44440 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_44440(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_44441 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_44441(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_44452 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_44452(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_44464 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_44464(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_44466 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_44466(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_44470 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_44470(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_44479 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_44479(b);
}
});
