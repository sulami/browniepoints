...
var G__50198 = o;
goog.object.set(G__50198,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__50391__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__50391 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50392__i = 0, G__50392__a = new Array(arguments.length -  0);
while (G__50392__i < G__50392__a.length) {G__50392__a[G__50392__i] = arguments[G__50392__i + 0]; ++G__50392__i;}
  args = new cljs.core.IndexedSeq(G__50392__a,0,null);
} 
return G__50391__delegate.call(this,args);};
G__50391.cljs$lang$maxFixedArity = 0;
G__50391.cljs$lang$applyTo = (function (arglist__50394){
var args = cljs.core.seq(arglist__50394);
return G__50391__delegate(args);
});
G__50391.cljs$core$IFn$_invoke$arity$variadic = G__50391__delegate;
return G__50391;
})()
;
} else {
...
var G__50206 = o;
goog.object.set(G__50206,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__50400__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__50403__i < G__50403__a.length) {G__50403__a[G__50403__i] = arguments[G__50403__i + 0]; ++G__50403__i;}
  args = new cljs.core.IndexedSeq(G__50403__a,0,null);
} 
return G__50400__delegate.call(this,args);};
G__50400.cljs$lang$maxFixedArity = 0;
G__50400.cljs$lang$applyTo = (function (arglist__50404){
var args = cljs.core.seq(arglist__50404);
return G__50400__delegate(args);
});
...
var G__50214 = props;
var G__50214__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50214,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50214);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50214__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__50214__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__50228 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50228,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__50228;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50241){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50242__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__50251_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__50251_SHARP_);
}));
} else {
return null;
}
...
var vec__50278 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50278,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50278,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50278,(2),null);
...
var temp__5739__auto___50463 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___50463 == null)){
} else {
var key_50464 = temp__5739__auto___50463;
(jsprops.key = key_50464);
}
...
var temp__5739__auto___50469 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___50469 == null)){
} else {
var key_50470 = temp__5739__auto___50469;
(jsprops.key = key_50470);
}
...
var G__50313 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__50313) : reagent.impl.template.as_element.call(null,G__50313));
} else {
var temp__5739__auto___50482 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___50482 == null)){
} else {
var key_50483 = temp__5739__auto___50482;
(jsprops.key = key_50483);
}
...
var G__50322 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__50322)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__50322)){
return x;
} else {
...
var len__4736__auto___50492 = arguments.length;
var i__4737__auto___50493 = (0);
while(true){
if((i__4737__auto___50493 < len__4736__auto___50492)){
args__4742__auto__.push((arguments[i__4737__auto___50493]));

var G__50495 = (i__4737__auto___50493 + (1));
i__4737__auto___50493 = G__50495;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50333){
var G__50334 = cljs.core.first(seq50333);
var seq50333__$1 = cljs.core.next(seq50333);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50334,seq50333__$1);
}));
...
var ctx = ({});
var vec__50359 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50359,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50359,(1),null);
...
var G__50369 = (cljs.core.count(argv) - first_child);
switch (G__50369) {
case (0):
