...
var o41905 = temp__5733__auto__;
var temp__5733__auto____$1 = (o41905["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o41906 = temp__5733__auto____$1;
return (o41906["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__41211__auto__ = f;
return (o__41211__auto__["toString"]).call(o__41211__auto__);
} else {
return "";
}
}catch (e41912){var _ = e41912;
return "";
}});
...
try{var o__41211__auto___42207 = t;
(o__41211__auto___42207["cljs$lang$ctorPrWriter"]).call(o__41211__auto___42207,t,writer);
}catch (e41921){var __42208 = e41921;
}
...
var char_code = (function (){var o__41211__auto__ = (new String(char$));
return (o__41211__auto__["charCodeAt"]).call(o__41211__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__41211__auto__ = String;
return (o__41211__auto__["fromCharCode"]).call(o__41211__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__41930 = num_code;
switch (G__41930) {
case (1):
return (185);
...
var o__41211__auto__ = String;
return (o__41211__auto__["fromCharCode"]).call(o__41211__auto__,superscript_code);
});
/**
...
}catch (e41953){var _e__41243__auto__ = e41953;
return false;
}})())){
...
var vec__41955 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41955,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__41982){
var vec__41983 = p__41982;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41983,(0),null);
...
var G__42239 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__42240 = cljs.core.butlast(remaining_tokens);
name_tokens = G__42239;
remaining_tokens = G__42240;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq41976){
var G__41977 = cljs.core.first(seq41976);
var seq41976__$1 = cljs.core.next(seq41976);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41977,seq41976__$1);
}));
...
var vec__41998 = cljs.core.split_with((function (p1__41996_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__41996_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41998,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41998,(1),null);
...
var vec__42010 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42010,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42010,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__42249 = cljs.core.rest(remaining_tokens);
var G__42250 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__42249;
name_tokens = G__42250;
continue;
} else {
...
var vec__42021 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42021,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42021,(1),null);
var vec__42024 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42024,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42024,(1),null);
var vec__42027 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42027,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42027,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42027,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42027,(3),null);
...
var vec__42038 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42038,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42038,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42038,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42038,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42038,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42038,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42044 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42044,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42044,(1),null);
var vec__42047 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42047,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42047,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42055 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42055) : devtools.munging.parse_fn_info_deep.call(null,G__42055));
})()));
}
} else {
return fn_info;
...
var G__42269 = (arity + (1));
var G__42270 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42067){
var vec__42068 = p__42067;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42068,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42068,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42080_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42080_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42081_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42081_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___42280 = arguments.length;
var i__4737__auto___42281 = (0);
while(true){
if((i__4737__auto___42281 < len__4736__auto___42280)){
args__4742__auto__.push((arguments[i__4737__auto___42281]));

var G__42282 = (i__4737__auto___42281 + (1));
i__4737__auto___42281 = G__42282;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42101){
var vec__42103 = p__42101;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42103,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42086){
var G__42087 = cljs.core.first(seq42086);
var seq42086__$1 = cljs.core.next(seq42086);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42087,seq42086__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42146__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42146__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42146__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42146__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42147 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42147,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42147,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42147,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42147,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42147,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42147,(5),null);
...
var o__41211__auto__ = f;
return (o__41211__auto__["getBasis"]).call(o__41211__auto__);
});
/**
...
}catch (e42160){var _e__41243__auto__ = e42160;
...
var G__42297 = (obj[cljs.core.first(path)]);
var G__42298 = cljs.core.rest(path);
obj = G__42297;
path = G__42298;
continue;
} else {
...
var _STAR_ = (function (accum,p__42174){
var vec__42175 = p__42174;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42175,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42175,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__42180){
var vec__42183 = p__42180;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42183,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42183,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42183,(2),null);
...
var post_process = (function (p__42196){
var vec__42197 = p__42196;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42197,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42197,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42192_SHARP_){
return (obj[cljs.core.first(p1__42192_SHARP_)]);
}),sorted_matches);
